    ...
    <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-[96rem] mx-auto">
      ...
      <div className="sm:flex sm:justify-between sm:items-center mb-8">
        <div className="mb-4 sm:mb-0">
          <h1 className="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">Pool & Network Statistics</h1>
        </div>
      </div>
      ...
      <div className="grid grid-cols-12 gap-6 mb-8">
        <StatCard
          dataType="poolHashrate"
          label="Kat Pool Hashrate"
          icon={
        ...
        />
        <StatCard
          dataType="pool24hBlocks"
          label="Pool 24h Blocks"
          icon={
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        />
        <StatCard
          dataType="minedPercent"
          label="% of Supply Mined"
          icon={
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
